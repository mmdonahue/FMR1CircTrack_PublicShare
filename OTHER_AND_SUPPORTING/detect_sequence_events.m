function [dir, winStartTms, winEndTms] = detect_sequence_events(pxn, spkRstr, Fs, radPos, radBinCtrs, bothDir)
% function [dir, winStartTms, winEndTms] = detect_sequence_events(pxn, spkRstr, Fs, radPos, radBinCtrs, bothDir)
%
% PURPOSE:
...
%   winStartTms = start times for each bin of pxn
%   winEndTms = end times for each bin of pxn
%
% OPTIONS:
...
% Fs = 20000; %Hz - spike sampling rate for spike raster input to Bayesian decoder
...
winStartTms = radPos(1,1) + winStartInds/Fs - 1/Fs;
